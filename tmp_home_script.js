...
<div class="chat-container-card">
    <div class="app-layout">
        <aside class="sidebar" id="sidebarMenu">
            ...
            <div class="conv-list">
                <div class="conv-item active" onclick="clearChat()">
                    <span>💬</span>
                    <span class="title">Current Chat</span>
                </div>
                <div class="conv-item" onclick="preFillQuestion('Explain this in simple terms')">
                    <span>⚡</span>
                    <span class="title">Quick Demo</span>
                </div>
            </div>
            ...
            <div class="util-tray">
                ...
                <button onclick="exportChat()">💾 Export Journey</button>
            </div>
        </aside>
        ...
        <main class="main-container">
            <div class="topbar">
                ...
                <div class="title">Nakintu AI</div>
                <div id="localTimeDisplay" class="time"></div>
            </div>
            ...
            <div id="chatLog">
                <div class="chat-message ai">
                    ...
                    <div class="content">
                        ...
                        <p>Welcome! I'm your personal learning companion with world-class teaching skills. I understand Ugandan, African, and global languages, and I’m built to keep conversations helpful and dependable.</p>
                        <p style="margin-top:0.5rem;color:#677178;font-size:0.95rem">💡 Try: "Explain photosynthesis" or ask in Luganda, Swahili, Hausa, French, Arabic, or your preferred language.</p>
                    </div>
                </div>
            </div>

            <div id="voiceStatus">Tap the mic to start voice input. Say 'stop' to end speech.</div>

            <div class="input-wrapper">
                <div class="composer">
                    <button id="recordButton" onclick="toggleRecording()" class="action-icon-button" title="Start Recording">🎤</button>
                    <textarea id="chatInput" placeholder="Ask Nakintu anything..." rows="1" onkeydown="handleKeydown(event)"></textarea>
                    <select id="languageSelector" class="language-selector" aria-label="Choose language">
                    ...
                    <button onclick="typeQuery()" class="action-icon-button" id="sendChatButton" title="Send Message">➤</button>
                </div>
            </div>
        </main>
    </div>
...
Please proceed with your location-based query (e.g., "What is the weather like here?").`;
    ...
    function formatAiResponseHtml(text) {
        ...
        try {
            ...
            // This handles: **bold**, *italic*, # headings, - lists, | tables |, code blocks, etc.
            ...
            // Add CSS classes for better styling of parsed elements
...
// NOTE: The female voice ('Samantha') has been removed to ensure an exclusively male/neutral voice selection.
    ...
    function appendMessage(sender, text, isError = false, positiveFeedback = false) {
        ...
        const profileLabel = sender === 'ai' ? 'Nakintu AI' : 'You';
  ...
  try {
    ...
    function loadChatHistoryFromLocalStorage() {
        ...
        history.forEach(item => {
            appendMessage(item.role, item.text, false, item.positiveFeedback || false);
        });
    }

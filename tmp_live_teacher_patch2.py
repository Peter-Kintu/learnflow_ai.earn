...
text = text.replace("    'jazzmin', # Keep Jazzmin just above admin\n", "    'jazzmin', # Keep Jazzmin just above admin\n    'channels',\n    'daphne',\n")
...
if 'CHANNEL_LAYERS' not in text:
    text = text.replace("ASGI_APPLICATION = 'learnflow_ai.asgi.application'\n\n", "ASGI_APPLICATION = 'learnflow_ai.asgi.application'\n\nCHANNEL_LAYERS = {\n    'default': {\n        'BACKEND': 'channels.layers.InMemoryChannelLayer',\n    },\n}\n\n")
...
print('patched settings and asgi')
